...
import com.example.bkashabed.BkashJavaScriptInterface;
import com.example.bkashabed.PaymentRequest;
import com.example.bkashabed.R;
import com.google.gson.Gson;

public class BkashActivityPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getExtras() == null) {
             ...
             */
            wvBkashPayment.addJavascriptInterface(new BkashJavaScriptInterface(BkashActivityPage.this), "AndroidNative");
    ...
    private void popupPaymentCancelAlert() {
        ...
        alert.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                Toast.makeText(BkashActivityPage.this, "Payment canceled", Toast.LENGTH_SHORT).show();
                BkashActivityPage.super.onBackPressed();
            }
        });
